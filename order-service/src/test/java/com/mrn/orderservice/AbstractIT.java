...
public abstract class AbstractIT {
    ...
    static final String CLIENT_SECRET = "zO8I2fn2iMhZqPuBlLvzfwEgroATf1Vx";
    static final String USERNAME = "bamboo";
    static final String PASSWORD = "bamboo123";
    ...
    protected String getToken() {
        ...
        //        System.out.println(oAuth2ResourceServerProperties.getJwt().getIssuerUri());
