...
import static com.mrn.orderservice.data.TestDataFactory.*;
...
import com.mrn.orderservice.domain.OrderService;
import com.mrn.orderservice.domain.SecurityService;
...
public class OrderControllerUnitTests {
    ...
    @BeforeEach
    void setUp() {
        given(securityService.getLoginUsername()).willReturn("suka");
    }
    ...
    void shouldReturnBadRequestWhenOrderPayloadIsInvalid(CreateOrderRequest request) throws Exception {
        given(orderService.createOrder(eq("suka"), any(CreateOrderRequest.class)))
                .willReturn(null);
